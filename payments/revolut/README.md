...
This is **not** the Celestify Marketplace module and contains no Celestify source, binaries, license checks, or reverse-engineered code. The goal is clean-room functional parity with the publicly advertised gateway behaviour, using current public APIs.
